...
> [!IMPORTANT]
> **We deeply value participation from people with disabilities.**
> Lived accessibility experience is essential to the quality of this work.
...
- **Links**: Use Jekyll's `{{ '/path/' | relative_url }}` filter for internal links
...
- **Found a barrier?** Label it `accessibility-barrier` for priority review
- **Need clarification?** Ask - clear documentation benefits everyone
