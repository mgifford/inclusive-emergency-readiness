---
layout: default
title: "Maps, Disasters, and Accessibility"
category: framework
summary: "How accessible mapping tools coordinate disaster response and help people with disabilities navigate emergencies safely."
...
**Link:** [hotosm.org](https://www.hotosm.org/en/){:target="_blank" rel="noopener noreferrer"}
...
**Link:** [ushahidi.com](https://www.ushahidi.com/){:target="_blank" rel="noopener noreferrer"}
...
**Link:** [missingmaps.org](https://www.missingmaps.org/){:target="_blank" rel="noopener noreferrer"}
...
**Link:** [resiliencymaps.org](https://resiliencymaps.org/){:target="_blank" rel="noopener noreferrer"}
...
**Link:** [wheelmap.org](https://wheelmap.org/){:target="_blank" rel="noopener noreferrer"}
...
**Link:** [OSM for the Blind Wiki](https://wiki.openstreetmap.org/wiki/OSM_for_the_blind){:target="_blank" rel="noopener noreferrer"}
...
**Link:** [NOSMAG Article](https://nosmag.org/building-urban-access-through-openstreetmap/){:target="_blank" rel="noopener noreferrer"}
...
**Link:** [Touch Mapper GitHub](https://github.com/skarkkai/touch-mapper){:target="_blank" rel="noopener noreferrer"}
...
**How to use:** [Perkins School for the Blind Guide](https://www.perkins.org/resource/how-create-3d-printable-maps-using-touch-mapper/){:target="_blank" rel="noopener noreferrer"}

### OSM2Tactile

**Link:** [OSM2Tactile GitHub](https://github.com/raphiniert/osm2tactile){:target="_blank" rel="noopener noreferrer"}
...
**Link:** [GetBraille Tactile Maps](https://getbraille.com/tactile-braille-maps/){:target="_blank" rel="noopener noreferrer"}
...
**Link:** [Vision IP Resource](https://www.visionip.org/how-braille-is-incorporated-into-public-maps-and-directories/){:target="_blank" rel="noopener noreferrer"}
...
**Link:** [OSM Disaster Response Wiki](https://wiki.openstreetmap.org/wiki/Disaster_Response_Checklist){:target="_blank" rel="noopener noreferrer"}
...
**Link:** [HeidelbergAI Article](https://heigit.org/five-open-source-tools-to-harness-geographic-knowledge-for-disaster-management/){:target="_blank" rel="noopener noreferrer"}
...
**Link:** [Mapbox Blog Post](https://www.mapbox.com/blog/optimize-crisis-response-with-openstreetmap-disaster-ninja){:target="_blank" rel="noopener noreferrer"}
...
**Link:** [TechScholar Article](https://techscholarclub.com/osm-in-disaster-management/){:target="_blank" rel="noopener noreferrer"}
...
**Link:** [Million Lives Project](https://www.millionlives.co/members/open-mapping-for-community-development-and-disaster-response){:target="_blank" rel="noopener noreferrer"}
...
**Have experience with emergency mapping? [Open an issue](https://github.com/mgifford/inclusive-emergency-readiness/issues) to share what you've learned.**
