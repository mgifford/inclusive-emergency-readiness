...
**My Doctor:** _______________
**Doctor Phone:** _______________

**My Pharmacy:** _______________
...
**What I use:** _______________

**How it helps:** _______________

**If power fails, I will:** _______________

**What I need:** _______________

**Where I keep it:** _______________
...
- [Start Now Guide]({{ '/framework/start-now.html' | relative_url }}) - Begin in 30 minutes
- [Physical-Digital Intersection]({{ '/framework/physical-digital.html' | relative_url }}) - Shelter accessibility
- [Data-Driven Readiness]({{ '/framework/data-driven-readiness.html' | relative_url }}) - Medical equipment registries
...
**Share your feedback:**
- [Open an issue](https://github.com/mgifford/inclusive-emergency-readiness/issues)
- [Read our contributing guide]({{ '/CONTRIBUTING.html' | relative_url }})
