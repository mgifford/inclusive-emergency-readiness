---
layout: default
title: "Ready-Willing-Able (RWA) Framework"
category: framework
summary: "A self-assessment framework to help organizations evaluate their readiness, willingness, and ability to implement inclusive emergency communications."
...
4. **Do pre-written alert templates exist?**
   - [ ] Yes
   - [ ] No → [Emergency Templates]({{ '/templates/' | relative_url }})

5. **Are templates translated into community languages?**
   - [ ] Yes
   - [ ] No → [Multi-Platform Toolkit]({{ '/toolkits/multi-platform.html' | relative_url }})

6. **Is a low-bandwidth crisis mode available?**
   - [ ] Yes
   - [ ] No → [Crisis Mode Guide]({{ '/CRISIS_MODE.html' | relative_url }})
...
9. **Are alternative formats (audio, video, ASL) pre-approved?**
   - [ ] Yes
   - [ ] No → [Disability Spectrum Guide]({{ '/disabilities/' | relative_url }})

**Ready Score:** ___/6

### Able: Staff Competency

10. **Can staff write at Grade 6 reading level?**
    - [ ] Yes
    - [ ] No → [Plain Language Toolkit]({{ '/toolkits/plain-language.html' | relative_url }})
...
- [Disability Spectrum Guide]({{ '/disabilities/' | relative_url }})
...
**Resources:**
- [Emergency Templates]({{ '/templates/' | relative_url }})
- [Crisis Mode Guide]({{ '/CRISIS_MODE.html' | relative_url }})
- [Multi-Platform Toolkit]({{ '/toolkits/multi-platform.html' | relative_url }})
...
- [Workflow Guide]({{ '/framework/workflows-guide.html' | relative_url }})
...
**Found a gap in the RWA Framework?** [Open an issue](https://github.com/mgifford/inclusive-emergency-readiness/issues).

**Want to share your RWA journey?** [Contribute your story]({{ '/CONTRIBUTING.html' | relative_url }}).

**Need help implementing?** Review the [Resource Directory]({{ '/framework/resources.html' | relative_url }}) for expert guidance.
