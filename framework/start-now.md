...
**Steps:**
1. Go to [Emergency Templates]({{ '/templates/' | relative_url }})
2. Pick one template
3. Fill in your local info
4. Send it through your alert system
5. Done
...
**Steps:**
1. Create 3 alert templates for common events:
   - Evacuation order
   - Shelter-in-place
   - Weather warning
2. Save them in your alert system
3. Add two distribution channels (not just one)
4. Test sending through both channels
5. Done
...
**Steps:**
1. Complete the [RWA Self-Assessment]({{ '/framework/rwa-framework.html' | relative_url }})
2. Create alerts in 3 formats:
   - Standard text
   - Easy Read version
   - One other language in your area
3. Set up 4 distribution channels:
   - Official website
   - SMS/text alerts
   - Social media
   - One backup channel
4. Train your team on Plain Language
5. Run one test drill
6. Done
...
1. Open [Emergency Templates]({{ '/templates/' | relative_url }})
2. Pick one template
3. Fill in your info
4. Send it through your system
...
**Want to learn more?**  
[The Access Spectrum]({{ '/disabilities/' | relative_url }})
